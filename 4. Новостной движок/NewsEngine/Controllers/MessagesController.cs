...
namespace NewsEngine.Controllers
{
    public class MessagesController : Controller
    {
        ...
        ////{
        ////    return View(db.Messages.Include(x => x.Replies).OrderByDescending(x => x.PublishDate).ToList());
        ////    //return View(db.Messages.OrderByDescending(x => x.PublishDate).Select(x=>new { Message=x, Replies=x.Replies.Count}));
        ////    //return View(db.Messages.OrderByDescending(x => x.PublishDate).ToList());
        ////}
